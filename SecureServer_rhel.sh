#!/usr/bin/env bash
#Linux Basic Security Setup v1.3[rhel]
DATE=$(date +"%m-%d-%Y")
TIME=$(date +"%r")
white=$'\e[0m'
echo ""
...
echo $'\e[1;41m'#######################################$'\e[0m'
echo ""
echo -e "\e[1;36mLinux Basic Security Setup v1.3 [rhel] \e[0m"
echo ""
...
echo ""
echo "------------------------------------"
sh /usr/src/Server_Audit/rhel/update_system.sh
echo ""
echo ""
echo -e "\e[1;33m2. Disabling SELINUX\e[0m"
echo "------------------------------------"
sh /usr/src/Server_Audit/rhel/selinux_disable.sh
echo ""
echo ""
echo -e "\e[1;33m3. SSH Port change to$red 33122\e[0m"
echo "------------------------------------"
sh /usr/src/Server_Audit/rhel/ssh_port_change.sh
echo ""
echo ""
echo -e "\e[1;33m4. Rkhunter Installation\e[0m"
echo "------------------------------------"
sh /usr/src/Server_Audit/rhel/rkhunter_setup.sh
echo ""
echo ""
echo -e "\e[1;33m5. CSF Installation\e[0m"
echo "------------------------------------"
sh /usr/src/Server_Audit/rhel/csf_setup.sh
echo ""
echo ""
echo -e "\e[1;33m6. Adding Admin and Cloudflare IPs\e[0m"
echo "------------------------------------"
sh /usr/src/Server_Audit/rhel/allow_ips.sh
echo ""
echo ""
##Main Script Ends
